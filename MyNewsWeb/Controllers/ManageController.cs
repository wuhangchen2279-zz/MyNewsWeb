    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                FileName = currentUser.UserInfo.FileName,
                Street = currentUser.UserInfo.Street,
                Suburb = currentUser.UserInfo.Suburb,
                State = currentUser.UserInfo.State,
                DateOfBirth = currentUser.UserInfo.DateOfBirth,
                PostCode = currentUser.UserInfo.PostCode
            };
            return View(model);
        }
        ...
        public async Task<ActionResult> Index(IndexViewModel model, HttpPostedFileBase postedFile)
        {
            if (ModelState.IsValid)
            {
                ...
                if (postedFile != null)
                {
                    ...
                    user.UserInfo.FileName = postedFile.FileName;
                }
